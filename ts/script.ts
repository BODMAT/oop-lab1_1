class Polygon {
    ...
    private arePointsCollinear(coords: number[][]): boolean {
    ...
    public drawPolygon(color: string = "red"): void {
        const svgNamespace = "http://www.w3.org/2000/svg";
        const svg: SVGSVGElement = document.querySelector(".polygonCanvas");
...
const polygon1: Polygon = new Polygon([[1, 2], [4, 5], [7, 2]]);
...
const polygon2: Polygon = new Polygon([[0, 0], [100, 0], [100, 100], [0, 100]]);
